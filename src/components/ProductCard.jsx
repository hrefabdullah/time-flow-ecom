...
const ProductCard = ({ item }) => {
  ...
  return (
    <div className={`bg-white h-full min-w-[145px] md:min-w-[300px] md:w-[10vw] p-2 rounded-lg shadow-lg flex flex-col justify-center items-center hover:scale-102`}>
        <img className='md:w-[20vw] w-[25vw] min-w-[130px] md:h-[16vh] lg:h-[18vh] h-[17vh] object-contain' onMouseEnter={() => setImg(item.img3)} onMouseOut={() => setImg(item.img1)} src={img} alt={item.name}  />
