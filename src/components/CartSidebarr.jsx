    ...
    return (
        <>
            ...
            <motion.div
                ...
                className={`overflow-y-scroll place-self-end w-[50%] z-50 fixed top-0 right-0 h-full md:w-[35%] lg:w-[20%] p-5 ${isDark ? 'bg-[#13131a] text-white' : "bg-zinc-200 text-[#101019]"} transition-colors duration-300 flex flex-col`}>
                ...
                {cartLength.length ? <div className='flex flex-col '>
                ...
                <div className='flex gap-3 justify-center place-items-end h-full mt-7'>
                    ...
                    <div className='flex items-center text-2xl font-semibold bg-red-500 w-max  px-2 py-2.5 rounded-lg text-white gap-3'>
