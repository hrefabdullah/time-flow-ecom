    ...
    return (
        <div className='w-[100%] min-h-[60px] h-[8vh] md:h-[9vh] border-b-1 flex justify-between items-center md:px-[30px] px-[20px] z-5'>
            <div className='flex items-center gap-[3px]'>
                <h1 className='font-semibold text-md md:text-lg lg:text-2xl'>T1MEFLOW</h1>
                <div className='h-3 lg:h-4.5 w-1 bg-blue-700 rotate-14'></div>
                <div className='h-3 lg:h-4.5 w-1 bg-blue-300 rotate-14'></div>
            </div>
            <ul className='hidden md:flex justify-between gap-4 text-sm lg:text-md'>
            ...
            <div className='flex gap-2 text-lg lg:text-xl px-3 '>
                ...
                <button className='mr-1'>
                    <div className='absolute top-[30px] right-[55px] h-3.5 w-3.5 rounded-full bg-blue-700 text-xs place-content-center'>
                        <h1>0</h1>
                    </div>
